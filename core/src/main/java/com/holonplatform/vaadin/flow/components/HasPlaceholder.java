...
import com.holonplatform.vaadin.flow.internal.components.CallbackHasPlaceholder;

/**
 * Represents a component which supports a <em>placeholder</em> text.
 *
 * @since 5.2.0
 */
public interface HasPlaceholder {
	 ...
	 * @return The placeholder text (may be null)
	 */
