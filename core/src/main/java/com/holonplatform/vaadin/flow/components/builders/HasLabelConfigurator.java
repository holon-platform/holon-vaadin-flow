...
public interface HasLabelConfigurator<C extends HasLabelConfigurator<C>> {
	...
	/**
	 * Sets the caption text using a {@link Localizable} message. In order for the localization to work, a
	 ...
	 * A <code>null</code> value is interpreted as an empty text.
	 * </p>
	 * @param text Localizable caption message (may be null)
	 * @return this
	 * @deprecated Use {@link #label(Localizable)}
	 */
	@Deprecated
	...
	/**
	 * Sets the caption text, replacing any previous content.
	 * <p>
	 * The text value is interpred as <em>plain text</em> and the HTML markup is not supported.
	 * </p>
	 * <p>
	...
	/**
	 * Sets the caption text using a localizable <code>messageCode</code>. In order for the localization to work, a
	 * {@link LocalizationContext} must be valid (localized) and as a {@link Context} resource.
	 * <p>
	 * The text value is interpred as <em>plain text</em> and the HTML markup is not supported.
	 * </p>
	 * @param defaultText Default caption text if no translation is available for given <code>messageCode</code>.
	 * @param messageCode Caption text translation message key
	 * @param arguments Optional translation arguments
	 * @return this
	 * @deprecated Use {@link #label(String, String, Object...)}
	 */
	@Deprecated
	default C caption(String defaultText, String messageCode, Object... arguments) {
		return label(defaultText, messageCode, arguments);
	}
