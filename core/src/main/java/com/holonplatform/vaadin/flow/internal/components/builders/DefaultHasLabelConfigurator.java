 ...
 * @since 5.2.0
 */
public class DefaultHasLabelConfigurator extends AbstractLocalizationSupportConfigurator<HasLabel>
		implements HasLabelConfigurator<DefaultHasLabelConfigurator> {

	private static final Logger LOGGER = VaadinLogger.create();

	private final HasLabel component;

	/**
	 * Constructor.
	 * @param component Component to configure (not null)
	 */
	public DefaultHasLabelConfigurator(HasLabel component) {
		this(component, null);
	}
	 ...
	 */
	public DefaultHasLabelConfigurator(HasLabel component, HasDeferrableLocalization deferrableLocalization) {
		super(text -> component.setLabel(text), deferrableLocalization);
	 ...
	 */
	@Override
	public DefaultHasLabelConfigurator label(Localizable label) {
