...
/**
 * A {@link BaseDateInputBuilder} to create {@link LocalDate} type {@link Input} components.
 *
 * @since 5.2.0
 */
public interface LocalDateInputBuilder extends BaseDateInputBuilder<LocalDate, LocalDateInputBuilder> {
