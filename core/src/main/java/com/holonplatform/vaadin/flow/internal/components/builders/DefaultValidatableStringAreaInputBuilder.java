...
/**
 * Default {@link ValidatableStringAreaInputBuilder} implementation.
 *
 * @since 5.2.2
 */
public class DefaultValidatableStringAreaInputBuilder extends
	 ...
	 */
	@Override
	protected ValidatableStringAreaInputBuilder getConfigurator() {
		return this;
	}
	 ...
	 */
	@Override
	public ValidatableStringAreaInputBuilder withValidator(Validator<String> validator) {
	 ...
	 */
	@Override
	public ValidatableStringAreaInputBuilder validationStatusHandler(
	 ...
	 */
	@Override
	public ValidatableStringAreaInputBuilder validateOnValueChange(boolean validateOnValueChange) {
	 ...
	 */
	@Override
	public ValidatableStringAreaInputBuilder required(Validator<String> validator) {
	 ...
	 */
	@Override
	public ValidatableStringAreaInputBuilder required(Localizable message) {
	 ...
	 */
	@Override
	public ValidatableStringAreaInputBuilder required(boolean required) {
