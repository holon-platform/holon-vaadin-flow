 ...
 * @since 5.2.0
 */
public interface LocalTimeInputBuilder extends LocalTimeInputConfigurator<LocalTimeInputBuilder>,
		InputBuilder<LocalTime, ValueChangeEvent<LocalTime>, Input<LocalTime>, ValidatableInput<LocalTime>, LocalTimeInputBuilder, ValidatableLocalTimeInputBuilder> {
