...
@SpringBootTest(webEnvironment=WebEnvironment.RANDOM_PORT, classes=TestNavigatorAutoConfiguration.Config.class)
public class TestNavigatorAutoConfiguration extends AbstractVaadinSpringBootTest {
