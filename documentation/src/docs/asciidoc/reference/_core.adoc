...
<2> Add a input value `Validator`
<1> Use the `ValidatableInput` _from_ method to directly create a validatable input from a standard `Input`
<2> Add a input value `Validator` using the `addValidator` method
